...
"""Uploads and downloads from GCS."""
...
def upload_directory(local_dir: str, bucket_name: str, gcs_path: str) -> None:
    ...
    Args:
        ...
        bucket_name: name of the gcs bucket.  If the bucket doesn't exist, the
            method tries to create one.
...
def download_directory(local_dir: str, bucket_name: str, gcs_path: str) -> None:
    ...
    Args:
        local_dir: path to the local directory to store the downloaded files.
