    ...
    def start_translation(self) -> None:
        ...
        if self.config.translation_config.source_target_location_mapping:
            ...
            if local_input_dir != "client/input":
                local_source_target_location_mapping[abspath(local_input_dir)] = local_output_dir
            local_source_target_location_mapping.update(self.config.translation_config.source_target_location_mapping)
