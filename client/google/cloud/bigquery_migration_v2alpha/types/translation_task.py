...
class DatasetReference(proto.Message):
    ...
    Attributes:
        ...
        dataset_id_alternative (Sequence[str]):
            ...
            to translate the received data to the dataset_id field. See
            details at go/dealing_with_apiary_lax_array_parsing.
        project_id_alternative (Sequence[str]):
            The alternative field that will be used when ESF is not able
            to translate the received data to the project_id field. See
            details at go/dealing_with_apiary_lax_array_parsing.
    """
