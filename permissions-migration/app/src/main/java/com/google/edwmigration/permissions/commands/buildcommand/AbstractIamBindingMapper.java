...
public abstract class AbstractIamBindingMapper<T> extends AbstractRuleSetMapper<T, IamBinding> {

  protected AbstractIamBindingMapper(
      Class<? extends IamBinding> resultClass,
      String sourceName,
      RuleSetCompiler ruleSetCompiler,
      ImmutableList<Rule> rules) {
    super(resultClass, sourceName, ruleSetCompiler, rules);
  }
}
