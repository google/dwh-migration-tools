...
public class BigQueryAccessor {
    ...
    private static class JobPageFetcher implements NextPageFetcher<Job> {
        ...
        JobPageFetcher(BigQueryOptions serviceOptions, String projectId, String cursor, Map<BigQueryRpc.Option, ?> optionMap) {
            this.requestOptions
    ...
    public static <T extends JobStatistics> T JobStatistics_fromPb(com.google.api.services.bigquery.model.Job jobPb) {
        com.google.api.services.bigquery.model.JobConfiguration jobConfigPb = jobPb.getConfiguration();
        // This is the critical null-check to work aroud https://github.com/googleapis/java-bigquery/issues/186
        if (jobConfigPb == null)
            return null;
    ...
    @Nonnull
    public static JobInfo.BuilderImpl JobInfo_BuilderImpl_new(com.google.api.services.bigquery.model.Job jobPb) {
    ...
    @Nonnull
    public static Page<Job> listJobs(@Nonnull BigQueryOptions serviceOptions, @Nonnull String projectId, @Nonnull Map<BigQueryRpc.Option, ?> optionsMap) throws BigQueryException, RetryHelper.RetryHelperException {
        ...
        Iterable<Job> jobs
                = Iterables.transform(result.y(),
                    ...
                    public Job apply(com.google.api.services.bigquery.model.Job job) {
                        // Job.Builder builder = Job.newBuilder(serviceOptions.getService(), JobConfiguration.fr
                        // JobStatistics.fromPb(job);
                        return new Job(serviceOptions.getService(), JobInfo_BuilderImpl_new(job));
                    }
                });
        return new PageImpl<>(new JobPageFetcher(serviceOptions, projectId, cursor, optionsMap), cursor, jobs);
    }

    @Nonnull
    public static Page<Job> listJobs(BigQuery bigquery, String projectId, JobListOption... options) throws BigQueryException, RetryHelper.RetryHelperException {
