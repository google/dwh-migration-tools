...
public class RolePrincipalGrant implements org.apache.thrift.TBase<RolePrincipalGrant, RolePrincipalGrant._Fields>, java.io.Serializable, Cloneable, Comparable<RolePrincipalGrant> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String grantorName; // required
  /**
   * 
   * @see PrincipalType
   */
  public @org.apache.thrift.annotation.Nullable PrincipalType grantorPrincipalType; // required
      ...
      try {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 7: // GRANTOR_PRINCIPAL_TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.grantorPrincipalType = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.v2_3_6.PrincipalType.findByValue(iprot.readI32());
