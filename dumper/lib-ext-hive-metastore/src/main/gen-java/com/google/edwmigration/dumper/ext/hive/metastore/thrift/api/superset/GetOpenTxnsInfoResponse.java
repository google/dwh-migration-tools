...
public class GetOpenTxnsInfoResponse implements org.apache.thrift.TBase<GetOpenTxnsInfoResponse, GetOpenTxnsInfoResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetOpenTxnsInfoResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TxnInfo> open_txns; // required
  ...
  public GetOpenTxnsInfoResponse setOpen_txns(@org.apache.thrift.annotation.Nullable java.util.List<TxnInfo> open_txns) {
    this.open_txns = open_txns;
    return this;
  }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.open_txns = new java.util.ArrayList<TxnInfo>(_list618.size);
                  @org.apache.thrift.annotation.Nullable TxnInfo _elem619;
                  for (int _i620 = 0; _i620 < _list618.size; ++_i620)
                  {
                    _elem619 = new TxnInfo();
                    _elem619.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetOpenTxnsInfoResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.open_txns != null) {
        oprot.writeFieldBegin(OPEN_TXNS_FIELD_DESC);
        {
          ...
          for (TxnInfo _iter621 : struct.open_txns)
          {
  ...
  private static class GetOpenTxnsInfoResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetOpenTxnsInfoResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsInfoResponse struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.txn_high_water_mark);
      {
        ...
        for (TxnInfo _iter622 : struct.open_txns)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsInfoResponse struct) throws org.apache.thrift.TException {
      ...
      try {
        ...
        struct.setTxn_high_water_markIsSet(true);
        {
          ...
          struct.open_txns = new java.util.ArrayList<TxnInfo>(_list623.size);
          @org.apache.thrift.annotation.Nullable TxnInfo _elem624;
          for (int _i625 = 0; _i625 < _list623.size; ++_i625)
          {
            _elem624 = new TxnInfo();
            _elem624.read(iprot);
