...
public class WriteNotificationLogRequest implements org.apache.thrift.TBase<WriteNotificationLogRequest, WriteNotificationLogRequest._Fields>, java.io.Serializable, Cloneable, Comparable<WriteNotificationLogRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable InsertEventRequestData fileInfo; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> partitionVals; // optional
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list860.size);
                  @org.apache.thrift.annotation.Nullable java.lang.String _elem861;
                  for (int _i862 = 0; _i862 < _list860.size; ++_i862)
                  {
                    _elem861 = iprot.readString();
                    struct.partitionVals.add(_elem861);
                  }
                  iprot.readListEnd();
                }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter863 : struct.partitionVals)
            {
  ...
  private static class WriteNotificationLogRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<WriteNotificationLogRequest> {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter864 : struct.partitionVals)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WriteNotificationLogRequest struct) throws org.apache.thrift.TException {
      ...
      try {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list865 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list865.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem866;
            for (int _i867 = 0; _i867 < _list865.size; ++_i867)
            {
              _elem866 = iprot.readString();
              struct.partitionVals.add(_elem866);
            }
          }
          struct.setPartitionValsIsSet(true);
        }
