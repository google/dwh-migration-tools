...
public class WMGetAllResourcePlanResponse implements org.apache.thrift.TBase<WMGetAllResourcePlanResponse, WMGetAllResourcePlanResponse._Fields>, java.io.Serializable, Cloneable, Comparable<WMGetAllResourcePlanResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<WMResourcePlan> resourcePlans; // optional
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resourcePlans = new java.util.ArrayList<WMResourcePlan>(_list1040.size);
                  @org.apache.thrift.annotation.Nullable WMResourcePlan _elem1041;
                  for (int _i1042 = 0; _i1042 < _list1040.size; ++_i1042)
                  {
                    _elem1041 = new WMResourcePlan();
                    _elem1041.read(iprot);
                    struct.resourcePlans.add(_elem1041);
                  }
                  iprot.readListEnd();
                }
      ...
      if (struct.resourcePlans != null) {
        if (struct.isSetResourcePlans()) {
          oprot.writeFieldBegin(RESOURCE_PLANS_FIELD_DESC);
          {
            ...
            for (WMResourcePlan _iter1043 : struct.resourcePlans)
            {
  ...
  private static class WMGetAllResourcePlanResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<WMGetAllResourcePlanResponse> {
      ...
      if (struct.isSetResourcePlans()) {
        {
          ...
          for (WMResourcePlan _iter1044 : struct.resourcePlans)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WMGetAllResourcePlanResponse struct) throws org.apache.thrift.TException {
      ...
      try {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list1045 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            struct.resourcePlans = new java.util.ArrayList<WMResourcePlan>(_list1045.size);
            @org.apache.thrift.annotation.Nullable WMResourcePlan _elem1046;
            for (int _i1047 = 0; _i1047 < _list1045.size; ++_i1047)
            {
              _elem1046 = new WMResourcePlan();
              _elem1046.read(iprot);
              struct.resourcePlans.add(_elem1046);
            }
          }
          struct.setResourcePlansIsSet(true);
        }
