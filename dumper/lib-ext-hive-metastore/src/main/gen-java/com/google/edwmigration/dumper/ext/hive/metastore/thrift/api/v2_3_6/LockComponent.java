...
public class LockComponent implements org.apache.thrift.TBase<LockComponent, LockComponent._Fields>, java.io.Serializable, Cloneable, Comparable<LockComponent> {
   ...
   * @see LockType
   */
  public @org.apache.thrift.annotation.Nullable LockType type; // required
  /**
   * 
   * @see LockLevel
   */
  public @org.apache.thrift.annotation.Nullable LockLevel level; // required
  ...
  public boolean isAcid; // optional
  public boolean isDynamicPartitionWrite; // optional
  ...
  public LockComponent() {
    this.operationType = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.v2_3_6.DataOperationType.UNSET;
  ...
  public LockComponent setIsAcid(boolean isAcid) {
    this.isAcid = isAcid;
    setIsAcidIsSet(true);
    return this;
  }
          ...
          switch (schemeField.id) {
            case 1: // TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.type = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.v2_3_6.LockType.findByValue(iprot.readI32());
            ...
            case 2: // LEVEL
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.level = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.v2_3_6.LockLevel.findByValue(iprot.readI32());
            ...
            case 6: // OPERATION_TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.operationType = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.v2_3_6.DataOperationType.findByValue(iprot.readI32());
