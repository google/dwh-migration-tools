...
public class InsertEventRequestData implements org.apache.thrift.TBase<InsertEventRequestData, InsertEventRequestData._Fields>, java.io.Serializable, Cloneable, Comparable<InsertEventRequestData> {
  ...
  public boolean replace; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> filesAdded; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> filesAddedChecksum; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> subDirectoryList; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> partitionVal; // optional
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.filesAdded = new java.util.ArrayList<java.lang.String>(_list804.size);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.filesAddedChecksum = new java.util.ArrayList<java.lang.String>(_list807.size);
                  @org.apache.thrift.annotation.Nullable java.lang.String _elem808;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.subDirectoryList = new java.util.ArrayList<java.lang.String>(_list810.size);
                  @org.apache.thrift.annotation.Nullable java.lang.String _elem811;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.partitionVal = new java.util.ArrayList<java.lang.String>(_list813.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InsertEventRequestData struct) throws org.apache.thrift.TException {
      ...
      if (struct.filesAdded != null) {
        oprot.writeFieldBegin(FILES_ADDED_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter816 : struct.filesAdded)
          {
      ...
      if (struct.subDirectoryList != null) {
        if (struct.isSetSubDirectoryList()) {
          oprot.writeFieldBegin(SUB_DIRECTORY_LIST_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter818 : struct.subDirectoryList)
            {
      ...
      if (struct.partitionVal != null) {
        if (struct.isSetPartitionVal()) {
          oprot.writeFieldBegin(PARTITION_VAL_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter819 : struct.partitionVal)
            {
  ...
  private static class InsertEventRequestDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<InsertEventRequestData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, InsertEventRequestData struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.lang.String _iter820 : struct.filesAdded)
        {
      ...
      if (struct.isSetSubDirectoryList()) {
        {
          ...
          for (java.lang.String _iter822 : struct.subDirectoryList)
          {
      ...
      if (struct.isSetPartitionVal()) {
        {
          ...
          for (java.lang.String _iter823 : struct.partitionVal)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, InsertEventRequestData struct) throws org.apache.thrift.TException {
      ...
      try {
        ...
        {
          org.apache.thrift.protocol.TList _list824 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.filesAdded = new java.util.ArrayList<java.lang.String>(_list824.size);
        ...
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TList _list827 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            struct.filesAddedChecksum = new java.util.ArrayList<java.lang.String>(_list827.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem828;
        ...
        if (incoming.get(2)) {
          {
            org.apache.thrift.protocol.TList _list830 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            struct.subDirectoryList = new java.util.ArrayList<java.lang.String>(_list830.size);
        ...
        if (incoming.get(3)) {
          {
            ...
            struct.partitionVal = new java.util.ArrayList<java.lang.String>(_list833.size);
