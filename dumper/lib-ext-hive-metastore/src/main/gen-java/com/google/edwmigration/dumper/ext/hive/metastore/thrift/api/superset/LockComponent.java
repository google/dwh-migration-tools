...
public class LockComponent implements org.apache.thrift.TBase<LockComponent, LockComponent._Fields>, java.io.Serializable, Cloneable, Comparable<LockComponent> {
  ...
  public boolean isTransactional; // optional
      ...
      try {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // LEVEL
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.level = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.superset.LockLevel.findByValue(iprot.readI32());
