...
public class OpenTxnRequest implements org.apache.thrift.TBase<OpenTxnRequest, OpenTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<OpenTxnRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String replPolicy; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> replSrcTxnIds; // optional
  /**
   * 
   * @see TxnType
   */
  public @org.apache.thrift.annotation.Nullable TxnType txn_type; // optional
  ...
  public OpenTxnRequest() {
    ...
    this.txn_type = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.superset.TxnType.DEFAULT;
   ...
   * @see TxnType
   */
  public OpenTxnRequest setTxn_type(@org.apache.thrift.annotation.Nullable TxnType txn_type) {
      ...
      try {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 7: // TXN_TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.txn_type = com.google.edwmigration.dumper.ext.hive.metastore.thrift.api.superset.TxnType.findByValue(iprot.readI32());
