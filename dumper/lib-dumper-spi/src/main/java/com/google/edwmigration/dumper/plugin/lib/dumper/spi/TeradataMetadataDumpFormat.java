...
public interface TeradataMetadataDumpFormat {
    ...
    public static interface DiskSpaceVFormat {
        ...
        // TD 16.20.32.09 - complete set.
        public static enum Header {
            VProc, DatabaseName, AccountName, MaxPerm, MaxSpool, MaxTemp, CurrentPerm, CurrentSpool, CurrentPersistentSpool, CurrentTemp, PeakPerm, PeakSpool, PeakPersistentSpool, PeakTemp, MaxProfileSpool, MaxProfileTemp, AllocatedPerm, AllocatedSpool, AllocatedTemp, PermSkew, SpoolSkew, TempSkew
        }
    }
}
