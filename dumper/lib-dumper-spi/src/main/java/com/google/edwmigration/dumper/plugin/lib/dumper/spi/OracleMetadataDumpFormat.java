 ...
 *
 * ALL_* -- all info accesible to current user, including grants
 * DBA_* -- need SELECT ANY TABLE privilege, DBA ROLE
 * USER_* -- all schema _of_ current user
 * We should prefer DBA_* , but have a fallback of ALL_* and USER_*
 * The names here are without prefix
 *
 */
