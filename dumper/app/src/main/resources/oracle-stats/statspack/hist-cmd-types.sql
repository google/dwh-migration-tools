...
SELECT
  ...
  ss.delta_executions "DeltaExecutions",
  ss.px_servers_executions "PxServersExecutions",
  ss.delta_px_servers_executions "DeltaPxServersExecutions",
  ss.elapsed_time "ElapsedTime",
  ss.delta_elapsed_time "DeltaElapsedTime",
  ss.disk_reads "DiskReads",
  ss.delta_disk_reads "DeltaDiskReads",
  ss.direct_writes "DirectWrites",
  ss.delta_direct_writes "DeltaDirectWrites",
  ss.end_of_fetch_count "EndOfFetchCount",
  ss.delta_end_of_fetch_count "DeltaEndOfFetchCount",
  ss.rows_processed "RowsProcessed",
  ss.delta_rows_processed "DeltaRowsProcessed",
  ss.buffer_gets "BufferGets",
  ss.delta_buffer_gets "DeltaBufferGets",
  ss.cpu_time "CpuTime",
  ss.delta_cpu_time "DeltaCpuTime",
  ss.user_io_wait_time "UserIoWaitTime",
  ss.delta_user_io_wait_time "DeltaUserIoWaitTime",
  ss.cluster_wait_time "ClusterWaitTime",
  ss.delta_cluster_wait_time "DeltaClusterWaitTime",
  ss.application_wait_time "ApplicationWaitTime",
  ss.delta_application_wait_time "DeltaApplicationWaitTime",
  ss.concurrency_wait_time "ConcurrencyWaitTime",
  ss.delta_concurrency_wait_time "DeltaConcurrencyWaitTime",
  ss.plsql_exec_time "PlsqlExecTime",
  ss.delta_plsql_exec_time "DeltaPlsqlExecTime",
  ss.java_exec_time "JavaExecTime",
  ss.delta_java_exec_time "DeltaJavaExecTime",
