...
public abstract class AbstractJdbcConnector extends AbstractConnector {
   ...
   */
  @Nonnull
  private static ClassLoader newDriverClassLoader(@Nonnull ClassLoader parentClassLoader,
      @CheckForNull List<? extends String> driverPaths)
  ...
  @Nonnull
  private static Class<?> newDriverClass(@Nonnull ClassLoader driverClassLoader,
      @Nonnull String driverClassName) throws PrivilegedActionException {
  ...
  @Nonnull
  protected Driver newDriver(@CheckForNull List<? extends String> driverPaths,
      @Nonnull String... driverClassNames) throws SQLException {
    ...
    } catch (ReflectiveOperationException | PrivilegedActionException | MalformedURLException |
             RuntimeException e) {
      throw new SQLException(
  ...
  @Nonnull
  protected SimpleDriverDataSource newSimpleDataSource(@Nonnull Driver driver, @Nonnull String url,
      @Nonnull ConnectorArguments arguments) throws SQLException, MetadataDumperUsageException {
