...
public abstract class AbstractRedshiftConnector extends AbstractJdbcConnector {
  ...
  protected static final DateTimeFormatter SQL_FORMAT = DateTimeFormatter.ISO_OFFSET_DATE_TIME.withZone(
      ZoneOffset.UTC);
  ...
  public Handle open(ConnectorArguments arguments) throws Exception {
    ...
    Driver driver = newDriver(arguments.getDriverPaths(), "com.amazon.redshift.jdbc.Driver",
