...
public class MetadataDumper {
  ...
  private final DumperRunner dumperRunner;

  public MetadataDumper(DumperRunner dumperRunner) {
    this.dumperRunner = dumperRunner;
  }

  public void run(@Nonnull String... args) throws Exception {
    ConnectorArguments arguments = new ConnectorArguments(args);
    try {
      dumperRunner.run(arguments);
    } finally {
  ...
  public static void main(String... args) throws Exception {
    try {
      MetadataDumper main = new MetadataDumper(DumperRunner.getInstance());
