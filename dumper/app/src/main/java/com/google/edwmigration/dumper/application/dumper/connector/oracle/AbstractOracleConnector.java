 ...
 * <code>
 * expdp directory={oracle_directory} content=metadata_only full=y dumpfile={dumpfilename} | impdp
 * directory={oracle_directory} content=metadata_only full=y dumpfile ={dumpfile} sqlfile=ddl.sql
 * </code>
...
@RespectsInput(order = ConnectorArguments.OPT_PORT_ORDER, arg = ConnectorArguments.OPT_PORT, description = "The port of the server.", required = ConnectorArguments.OPT_REQUIRED_IF_NOT_URL, defaultValue =
    "" + AbstractOracleConnector.OPT_PORT_DEFAULT)
