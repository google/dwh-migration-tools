...
@RespectsInput(order = ConnectorArguments.OPT_PORT_ORDER, arg = ConnectorArguments.OPT_PORT, description = "The port of the server.", required = ConnectorArguments.OPT_REQUIRED_IF_NOT_URL, defaultValue =
    "" + PostgresqlMetadataConnector.OPT_PORT_DEFAULT)
@RespectsArgumentDatabaseForConnection
public class PostgresqlMetadataConnector extends AbstractPostgresqlConnector implements
    MetadataConnector, PostgresqlMetadataDumpFormat {
  ...
  public void addTasksTo(List<? super Task<?>> out, ConnectorArguments arguments) {
    ...
    // \l
    out.add(new JdbcSelectTask("database.csv",
    ...
    // \df - old postgresql
    out.add(new JdbcSelectTask("functions.csv",
    ...
    out.add(new JdbcSelectTask("functions-11.csv",
    ...
    // \dT
    out.add(new JdbcSelectTask("types.csv",
    ...
    // \da
    out.add(new JdbcSelectTask("aggregates.csv",
    ...
    out.add(new JdbcSelectTask("aggregates-11.csv",
    ...
    // \dC
    out.add(new JdbcSelectTask("casts.csv",
    ...
    out.add(new JdbcSelectTask(InformationSchemaColumns.ZIP_ENTRY_NAME_SYSTEM,
        "select * from information_schema.columns where table_schema in " + PG_SCHEMAS));
    out.add(new JdbcSelectTask(InformationSchemaColumns.ZIP_ENTRY_NAME,
    ...
    out.add(new JdbcSelectTask(PgViews.ZIP_ENTRY_NAME_SYSTEM,
        "select * from pg_views where schemaname in " + PG_SCHEMAS));
    out.add(new JdbcSelectTask(PgViews.ZIP_ENTRY_NAME,
