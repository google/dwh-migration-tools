...
public class ArgumentSummary {
    ...
    public ArgumentSummary(ConnectorArguments arguments) {
        ...
        this.queryLogStart = arguments.getQueryLogStart() == null ? null : arguments.getQueryLogStart().toLocalDateTime();
        this.getQueryLogEnd = arguments.getQueryLogEnd() == null ? null : arguments.getQueryLogEnd().toLocalDateTime();
