 ...
 * --connector netezza --user nz --host 192.168.199.128 --port 5480 --pass nz --driver /path/to/nzjdbc3.jar
 *
 * @author miguel
 */
...
@RespectsInput(order = ConnectorArguments.OPT_PORT_ORDER, arg = ConnectorArguments.OPT_PORT, description = "The port of the server.", required = ConnectorArguments.OPT_REQUIRED_IF_NOT_URL, defaultValue = "" + NetezzaMetadataConnector.OPT_PORT_DEFAULT)
@RespectsArgumentUser
@RespectsArgumentPassword
@RespectsArgumentUri
@RespectsArgumentDatabasePredicate
public class NetezzaMetadataConnector extends AbstractJdbcConnector implements MetadataConnector, NetezzaMetadataDumpFormat {
    ...
    private static class NetezzaDatabaseListTask extends AbstractJdbcTask<List<String>> {
        ...
        @Override
        protected List<String> doInConnection(TaskRunContext context, JdbcHandle jdbcHandle, ByteSink sink, Connection connection) throws SQLException {
        ...
        public List<String> run(TaskRunContext context) throws Exception {
            ...
            for (String databaseName : MoreObjects.firstNonNull(databaseNames, Collections.<String>emptyList())) {
                // TODO:
    ...
    public void addTasksTo(List<? super Task<?>> out, ConnectorArguments arguments) {
        ...
        out.add(new JdbcSelectTask("nz.version.csv",
                ...
                + "cast(version() as varchar(64)) as version, " // " + db + ".admin.admin._v_system_info.SYSTEM_SOFTWARE_VERSION
