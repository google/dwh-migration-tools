...
public class SnowflakeMetadataConnector extends AbstractSnowflakeConnector implements
    MetadataConnector, SnowflakeMetadataDumpFormat {
   ...
   */
  @ForOverride
  protected void addSqlTasks(@Nonnull List<? super Task<?>> out,
      @Nonnull Class<? extends Enum<?>> header, @Nonnull String format,
      @Nonnull TaskVariant is_task, @Nonnull TaskVariant au_task) {
    Task<?> t0 = new JdbcSelectTask(is_task.zipEntryName,
        String.format(format, is_task.schemaName, is_task.whereClause))
        .withHeaderClass(header);
    Task<?> t1 = new JdbcSelectTask(au_task.zipEntryName,
  ...
  public void addTasksTo(@Nonnull List<? super Task<?>> out,
    ...
    addSqlTasks(out, SnowflakeMetadataDumpFormat.DatabasesFormat.Header.class,
        getOverrideableQuery(arguments,
        ...
        new TaskVariant(SnowflakeMetadataDumpFormat.DatabasesFormat.AU_ZIP_ENTRY_NAME, AU,
            AU_WHERE));
    ...
    addSqlTasks(out, SnowflakeMetadataDumpFormat.SchemataFormat.Header.class,
        ...
        new TaskVariant(SnowflakeMetadataDumpFormat.SchemataFormat.AU_ZIP_ENTRY_NAME, AU,
            AU_WHERE));
    ...
    addSqlTasks(out, SnowflakeMetadataDumpFormat.TablesFormat.Header.class,
        ...
        new TaskVariant(SnowflakeMetadataDumpFormat.TablesFormat.AU_ZIP_ENTRY_NAME, AU,
    ...
    addSqlTasks(out, SnowflakeMetadataDumpFormat.ColumnsFormat.Header.class,
        ...
        new TaskVariant(SnowflakeMetadataDumpFormat.ColumnsFormat.AU_ZIP_ENTRY_NAME, AU,
            AU_WHERE));    // Very fast.
    ...
    addSqlTasks(out, SnowflakeMetadataDumpFormat.FunctionsFormat.Header.class,
        ...
        new TaskVariant(SnowflakeMetadataDumpFormat.FunctionsFormat.AU_ZIP_ENTRY_NAME, AU,
            AU_WHERE));
  }
