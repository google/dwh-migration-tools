...
public class ZonedIntervalIterableTest {
  ...
  ConnectorArguments.ZonedParser zonedParserStart = new ConnectorArguments.ZonedParser(
      ConnectorArguments.ZonedParser.DEFAULT_PATTERN,
      ConnectorArguments.ZonedParser.DayOffset.START_OF_DAY);
  ConnectorArguments.ZonedParser zonedParserEnd = new ConnectorArguments.ZonedParser(
      ConnectorArguments.ZonedParser.DEFAULT_PATTERN,
  ...
  private void assertIterations(int expected, @Nonnull String from, @Nonnull String to,
  ...
  public void testHours() {
    ...
    testIterable(2, ZonedIntervalIterable.forTimeUnitsUntil(
    ...
    int daysToExport = 1;
    testIterable(25,
        ZonedIntervalIterable.forTimeUnitsUntilNow(24 * daysToExport, ChronoUnit.HOURS));
  ...
  public void testForLogStartAndLogEnd() throws Throwable {
    ...
    ConnectorArguments arguments = new ConnectorArguments(new String[]{
        "--query-log-start", requestedStart.toString(), "--query-log-end", requestedEnd.toString(),
        "--connector", "foobar"
    });
  ...
  public void testForLogStartTimeAndLogEndTime() throws Throwable {
    ...
    DateTimeFormatter formatter = DateTimeFormatter.ofPattern(
        ConnectorArguments.ZonedParser.DEFAULT_PATTERN, Locale.US);
    ...
    ZonedDateTime expectedStart = requestedStartParsed.atZone(ZoneOffset.UTC)
        .truncatedTo(ChronoUnit.HOURS);
    ZonedDateTime expectedEnd = requestedEndParsed.atZone(ZoneOffset.UTC)
        .truncatedTo(ChronoUnit.HOURS);

    ConnectorArguments arguments = new ConnectorArguments(new String[]{
        "--query-log-start", requestedStart, "--query-log-end", requestedEnd, "--connector",
        "foobar"
    });
    checkIntervalForArguments(expectedStart, expectedEnd, arguments);
  }
  ...
  public void testForLogDays() throws Throwable {
    ...
    ZonedDateTime expectedStart = nowAtUTC.truncatedTo(ChronoUnit.HOURS).minusDays(daysExpected)
        .truncatedTo(ChronoUnit.HOURS);
    ZonedDateTime expectedEnd = nowAtUTC.truncatedTo(ChronoUnit.HOURS).plusHours(1)
        .truncatedTo(ChronoUnit.HOURS);
    ConnectorArguments arguments = new ConnectorArguments(new String[]{
  ...
  private void checkIntervalForArguments(ZonedDateTime expectedStart, ZonedDateTime expectedEnd,
      ConnectorArguments arguments) throws MetadataDumperUsageException {
