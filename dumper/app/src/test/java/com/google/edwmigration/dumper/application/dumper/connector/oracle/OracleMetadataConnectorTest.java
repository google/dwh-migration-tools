  ...
  public void addTasksTo_generatesMetadataSelectTasks() throws Exception {
    ...
    assertEquals(
        ...
        ImmutableList.of(
            ...
            "SELECT SEQUENCE_OWNER, SEQUENCE_NAME, DBMS_METADATA.GET_XML('SEQUENCE', SEQUENCE_NAME, SEQUENCE_OWNER) FROM DBA_SEQUENCES WHERE SEQUENCE_NAME NOT LIKE 'ISEQ$$_%'",
            "SELECT SEQUENCE_OWNER, SEQUENCE_NAME, DBMS_METADATA.GET_XML('SEQUENCE', SEQUENCE_NAME, SEQUENCE_OWNER) FROM ALL_SEQUENCES WHERE SEQUENCE_NAME NOT LIKE 'ISEQ$$_%'",
