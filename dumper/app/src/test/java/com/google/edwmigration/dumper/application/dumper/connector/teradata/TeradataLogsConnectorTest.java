...
public class TeradataLogsConnectorTest extends AbstractConnectorExecutionTest {
  ...
  public void testConnectorSynthetic() throws Exception {
    ...
    TeradataLogsConnector.TeradataLogsJdbcTask.EXPRESSION_VALIDITY_QUERY =
        "SELECT %s FROM %s FETCH FIRST 1 ROW ONLY";
  ...
  public void testHeaderAndColumns() {
    checkNames(TeradataLogsDumpFormat.Header.values(), TeradataLogsConnector.EXPRESSIONS);
    checkNames(
