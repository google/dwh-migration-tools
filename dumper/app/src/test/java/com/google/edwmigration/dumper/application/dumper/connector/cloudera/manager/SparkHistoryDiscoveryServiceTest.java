...
public class SparkHistoryDiscoveryServiceTest {
  ...
  public void resolveUrl_spark3_success() throws Exception {
    ...
    // Act
    Optional<String> result = service.resolveUrl("my-cluster", knoxClient);

    // Assert
    assertTrue(result.isPresent());
    assertEquals("https://knox-host/gateway/cdp-proxy-api/spark3history/api/v1", result.get());
  }
  ...
  public void resolveUrl_spark2_success() throws Exception {
    ...
    // Assert
    assertTrue(result.isPresent());
    assertEquals("https://knox-host/gateway/cdp-proxy-api/sparkhistory/api/v1", result.get());
  }
