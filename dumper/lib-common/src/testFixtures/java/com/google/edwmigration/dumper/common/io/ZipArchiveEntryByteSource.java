...
public class ZipArchiveEntryByteSource extends PathByteSource {
    ...
    @CheckForNull
    public static ZipArchiveEntryByteSource forZipEntryNameOrNull(@Nonnull String zipName, @Nonnull ZipFile zipFile, @Nonnull String zipEntryName) {
    ...
    @Nonnull
    public static ZipArchiveEntryByteSource forZipEntryName(@Nonnull String zipName, @Nonnull ZipFile zipFile, @Nonnull String zipEntryName) throws FileNotFoundException {
        ZipArchiveEntryByteSource source = forZipEntryNameOrNull(zipName, zipFile, zipEntryName);
        if (source == null)
            throw new FileNotFoundException("No " + zipEntryName + " in " + zipFile);
        return source;
    }
    ...
    public ZipArchiveEntryByteSource(@Nonnull String zipName, @Nonnull ZipFile zipFile, @Nonnull ZipArchiveEntry zipEntry) {
