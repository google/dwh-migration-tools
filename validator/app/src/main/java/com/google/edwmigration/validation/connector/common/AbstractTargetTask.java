...
public abstract class AbstractTargetTask {
  ...
  private final BigQueryHandle handle;

  public AbstractTargetTask(BigQueryHandle handle) {
    Preconditions.checkNotNull(handle, "Handle is null.");
    this.handle = handle;
  }

  public BigQueryHandle getHandle() {
    return handle;
  }
  ...
  public HashMap<String, DataType<? extends Number>> executeNumericColsQuery(
    ...
    BigQueryHandle bqHandle = getHandle();
  ...
  public void extractQueryResultsToTable(String query, String targetTableId, String dataset)
      throws Exception {
