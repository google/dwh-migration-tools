...
public class ValidationColumnMappingTest {
  ...
  public void testColumnEntry_AllNonNullNamesAndDataTypes() {
    ColumnMapping.ColumnEntry entry =
        new ColumnMapping.ColumnEntry(
  ...
  public void testValidationColumnMapping_DirectMatchingColumns() {
    ...
    ColumnMapping mapping = new ColumnMapping(columnMappings, sourceCols, targetCols, primaryKeys);
    List<ColumnMapping.ColumnEntry> entries = mapping.getColumnEntries();

    assertNotNull(entries);
    assertEquals(2, entries.size());

    ColumnMapping.ColumnEntry idEntry =
        entries.stream()
    ...
    ColumnMapping.ColumnEntry nameEntry =
        entries.stream()
  ...
  public void testValidationColumnMapping_WithPrimaryKeys() {
    ...
    ColumnMapping mapping =
        new ColumnMapping(ImmutableMap.of(), sourceCols, targetCols, primaryKeys);
    List<ColumnMapping.ColumnEntry> entries = mapping.getColumnEntries();
  ...
  public void testValidationColumnMapping_PrimaryKeyMappingConflict() {
    ...
    new ColumnMapping(columnMappings, sourceCols, targetCols, primaryKeys);
  }
  ...
  public void testValidationColumnMapping_DataTypeMismatch() {
    ...
    new ColumnMapping(ImmutableMap.of(), sourceCols, targetCols, ImmutableMap.of());
  }
  ...
  public void testValidationColumnMapping_TargetColumnNoSourceMatch() {
    ...
    ColumnMapping.ColumnEntry descEntry =
        entries.stream()
