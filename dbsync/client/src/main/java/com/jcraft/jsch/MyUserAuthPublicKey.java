...
public class MyUserAuthPublicKey extends UserAuth {
    ...
    private boolean _start(Session session, List<Identity> identities, List<String> pkmethods,
        ...
        for (String pkmethod : pkmethods) {
            session.getLogger().log(Logger.DEBUG, "pkmethod = " + pkmethod);
        ...
        session.getLogger().log(Logger.DEBUG, "rsamethods=" + rsamethods + ", nonrsamethods=" + nonrsamethods);
        ...
        iloop: for (Identity identity : identities) {
            ...
            session.getLogger().log(Logger.DEBUG, "For identity " + identity + ", algName = " + _ipkmethod);
            ...
            session.getLogger().log(Logger.DEBUG, "ipkmethods=" + ipkmethods);
