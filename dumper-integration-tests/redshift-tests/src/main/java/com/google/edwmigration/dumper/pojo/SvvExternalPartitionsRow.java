...
@AutoValue
public abstract class SvvExternalPartitionsRow {

  public static SvvExternalPartitionsRow create(
      String schemaname,
      String tablename,
      String values,
      String location,
      ...
      int compressed,
      String parameters) {
    return new AutoValue_SvvExternalPartitionsRow(
        schemaname,
        tablename,
        values,
        location,
  ...
  public static SvvExternalPartitionsRow create(ResultSet rs) throws SQLException {
    return SvvExternalPartitionsRow.create(
        getStringNotNull(rs, "schemaname"),
        getStringNotNull(rs, "tablename"),
        getStringNotNull(rs, "values"),
  ...
  public static SvvExternalPartitionsRow create(String[] csvLine) {
    return new AutoValue_SvvExternalPartitionsRow(
